...
export function Buttons(props : ButtonsProps) : ElementNode {
    ...
    const { wallet, fundingSource, style, locale, remembered, env, fundingEligibility, platform, commit,
        nonce, components, onShippingChange, personalization, clientAccessToken, content, enableFunding } = normalizeButtonProps(props);
    const { layout, shape, tagline } = style;

    const fundingSources = determineEligibleFunding({ fundingSource, layout, remembered, platform, fundingEligibility, components, onShippingChange, enableFunding });
